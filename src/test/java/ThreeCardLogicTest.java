...
public class ThreeCardLogicTest {
    ...
    @Test
    @DisplayName("Test High Cards with Ace as Highest")
    public void testHighCardsWithAce() {
        ArrayList<Card> dealer = createHand('H', 2, 'D', 3, 'C', 4);
        ArrayList<Card> player = createHand('S', 5, 'D', 6, 'C', 14); // Ace
